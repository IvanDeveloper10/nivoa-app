  ...
  return (
    <Fragment>
      ...
      <section className='h-full w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6 '>
        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 rounded-lg px-6 py-6 gap-3 hover:scale-95 hover:cursor-pointer transition-all'>
          ...
          <span className='text-fu font-extrabold'>Airpods Pro - Out Of Stock</span>
        </div>
        ...
        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 rounded-lg px-6 py-6 gap-3 hover:scale-95 hover:cursor-pointer transition-all'>
          ...
          <span className='text-fu font-extrabold'>Airpods 3 Premium - Out Of Stock</span>
          
        </div>

        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 rounded-lg px-6 py-6 gap-3 hover:scale-90 hover:cursor-pointer transition-all'>
          ...
          <span className='text-fu font-extrabold'>Headphone - Out Of Stock</span>
        ...
        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 rounded-lg px-6 py-6 gap-3 hover:scale-90 hover:cursor-pointer transition-all'>
          ...
          <span className='text-fu font-extrabold'>Control PlayStation 2 - Out Of Stock</span>
        ...
        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 rounded-lg px-6 py-6 gap-3 hover:scale-90 hover:cursor-pointer transition-all'>
          ...
          <span className='text-fu font-extrabold'>Headphone M45 - Out Of Stock</span>
         
        </div>

        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 rounded-lg px-6 py-6 gap-3 hover:scale-90 hover:cursor-pointer transition-all'>
          <img src='https://firebasestorage.googleapis.com/v0/b/nivoa-320a4.firebasestorage.app/o/products%2FChatGPT%20Image%2013%20mar%202026%2C%2006_08_07%20p.m..png?alt=media&token=d09d4995-e06c-4830-aaa6-04c295cbe572' alt='Airpods 3 Image' className='w-full' />
          <span className='text-fu font-extrabold'>Airpods 4 Gen - Out Of Stock</span>
        
        </div>

        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 px-6 py-6 gap-3 hover:scale-90 hover:cursor-pointer transition-all rounded-lg'>
          ...
          <span className='text-fu font-extrabold'>Headphone Ambie - Out Of Stock</span>
        ...
        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 px-6 py-6 gap-3 hover:scale-90 hover:cursor-pointer transition-all rounded-lg'>
          ...
          <span className='text-fu font-extrabold'>Mouse + Keyboard - Out Of Stock</span>
      ...
      <div className='flex justify-center items-center'>
        <Link to={'/shop'}>
          <button className='bg-gray-200 text-fu px-10 py-2 rounded-lg hover:cursor-pointer hover:scale-90 transition-all flex justify-center items-center gap-3'>
            View All Products
