    ...
    <Fragment>
      ...
      <section className='h-full w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6 '>
        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 rounded-lg px-6 py-6 gap-3 hover:scale-95 hover:cursor-pointer transition-all'>
          ...
          <button onClick={(e) => { e.stopPropagation(); handleGoShop(); }} className='flex justify-center items-center gap-3 bg-black text-white w-full py-2 hover:scale-90 hover:cursor-pointer transition-all rounded-lg text-fu'>
            <i className='fi fi-rr-shopping-cart-add flex justify-center items-center text-xl'></i>
            ADD TO CART
          </button>
        </div>
        ...
        <div onClick={handleGoShop} className='flex flex-col justify-end items-start border-2 border-zinc-300 rounded-lg px-6 py-6 gap-3 hover:scale-95 hover:cursor-pointer transition-all'>
          ...
          <button onClick={(e) => { e.stopPropagation(); handleGoShop(); }} className='flex justify-center items-center gap-3 bg-black text-white w-full py-2 hover:scale-90 hover:cursor-pointer transition-all rounded-lg text-fu'>
            <i className='fi fi-rr-shopping-cart-add flex justify-center items-center'></i>
            ADD TO CART
          </button>
        </div>
